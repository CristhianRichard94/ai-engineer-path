...
// Protects the todo app behind the shared-passcode session cookie. `/login`
// and `/api/session` are intentionally left unprotected (the matcher below
// excludes them, along with static assets).
